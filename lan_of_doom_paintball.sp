...
public void OnMapStart() {
  g_decal_indices[0] = PrecacheDecal("materials/spb/spb_shot1.vmt");
  g_decal_indices[1] = PrecacheDecal("materials/spb/spb_shot2.vmt");
  g_decal_indices[2] = PrecacheDecal("materials/spb/spb_shot3.vmt");
  g_decal_indices[3] = PrecacheDecal("materials/spb/spb_shot5.vmt");
  g_decal_indices[4] = PrecacheDecal("materials/spb/spb_shot6.vmt");
  g_decal_indices[5] = PrecacheDecal("materials/spb/spb_shot7.vmt");
